...
def run_test():
    ...
    # 1. Discover Hardware (Regex from HTML)
    print("[*] Discovering Hardware IDs...")
    discovered = set()
    try:
        r = client.get("https://www.starlink.com/account/home", headers={"User-Agent": UA, "cookie": raw_cookie})
        if r.status_code == 200:
            # Find IDs like Router-0100000000000000008B65AD or ut10588f9d-45017219-5815f472
        ...
        print(f"  [+] Found in HTML: {discovered}")
    except Exception as e:
        print(f"  [-] HTML Discovery Error: {e}")
